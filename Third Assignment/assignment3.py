...
def launch_attacks(G:nx.Graph, percentage:float, output_dir:str, graph_name:str) ->None:
    ...
    for x in range(num_steps):
        #get list of target nodes for each type of attack
        ...
        #apply all attacks to the respective copy of the dataset
        for k in range(5):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", type=int, help="number of nodes in generated datasets", default=100)
    parser.add_argument("-d", type=int, help="density of generated graphs", default=4)
    parser.add_argument("-prob", type=float, help="probability of new edge in generated graphs", default=0.3)
    parser.add_argument("-seed", type=int, help="seed", default=None)
    parser.add_argument("-perc", type=float, help="percentage of total nodes to attack at each round", default=0.1)
    parser.add_argument("-v", help="verbose output", action='store_true')
    parser.add_argument("-o", type=str, help="output directory", default="outputs/")
    cli_args = parser.parse_args()
    main(cli_args.f, cli_args.n, cli_args.d, cli_args.prob, cli_args.seed, cli_args.perc, cli_args.v, cli_args.o)